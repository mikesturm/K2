// PeopleMover – build/update People/Kinetic-People.md from @mentions
//
// This version:
//
...
// - NEVER writes tasks to People/Kinetic-People.md
// - Skips generated/system files (Kinetic-People.md itself, Kinetic-Tasks.md, Projects.md)
// - Parses existing People/Kinetic-People.md into:
...
const PEOPLE_FILE_PATH = "People/Kinetic-People.md";
const EXCLUDED_PATHS = new Set([
  normalizePath(PEOPLE_FILE_PATH),
  normalizePath("Tasks/Kinetic-Tasks.md"),
  normalizePath("Projects.md"),
]);
